...
class Configuration():
    def parse(self, unknown_arg_ok=False):
        ...
        parser.add_argument('--s4_iterations', default=150000, type=int)
        parser.add_argument('--s4_finetune', default=0, type=int)
        ...
        parser.add_argument('--s4_num_frames', default=50, type=int)
